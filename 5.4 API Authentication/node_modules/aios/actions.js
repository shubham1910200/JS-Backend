...
const Transport = function (ns, data, options) {
    // Basic options
    options = options || {};
...
Transport.prototype.toBin = function () {
    ...
    //   , true
    //   , this.serializeFunctions);
    const headerBson = bson_1.serialize(self.header, {
        serializeFunctions: this.serializeFunctions,
        checkKeys: this.checkKeys,
        ignoreUndefined: true
    });
    // Serialize the query
    const dataBson = bson_1.serialize(self.data, {
        serializeFunctions: this.serializeFunctions,
        checkKeys: this.checkKeys,
        ignoreUndefined: true
    });
...
const Response = function (data, opts) {
...
Response.prototype.parse = function (options) {
    ...
    const _header = bson_1.deserialize(_headerBuffer, _options);
    const _data = bson_1.deserialize(_dataBuffer, _options);
    this.header = _header;
    this.data = _data;
    // Set parsed
    this.parsed = true;
